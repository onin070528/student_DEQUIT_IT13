...
namespace student_DEQUIT_IT13 {
    ...
    public partial class StudentDBDataSet1 : global::System.Data.DataSet {
        ...
        public partial class StudentsDataTable : global::System.Data.TypedTableBase<StudentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StudentsRow AddStudentsRow(string full_name, string course, string year_level) {
            ...
            private void InitClass() {
                ...
                this.columnyear_level.MaxLength = 20;
            }
        ...
        public partial class StudentsRow : global::System.Data.DataRow {
            ...
            public string year_level {
                get {
                    try {
                        return ((string)(this[this.tableStudents.year_levelColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'year_level\' in table \'Students\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableStudents.year_levelColumn] = value;
                }
            }
            ...
            public bool Isyear_levelNull() {
                return this.IsNull(this.tableStudents.year_levelColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void Setyear_levelNull() {
                this[this.tableStudents.year_levelColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace student_DEQUIT_IT13.StudentDBDataSet1TableAdapters {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Students] WHERE (([student_id] = @Original_student_id) AND ((@IsNull_full_name = 1 AND [full_name] IS NULL) OR ([full_name] = @Original_full_name)) AND ((@IsNull_course = 1 AND [course] IS NULL) OR ([course] = @Original_course)) AND ((@IsNull_year_level = 1 AND [year_level] IS NULL) OR ([year_level] = @Original_year_level)))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_year_level", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "year_level", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Students] ([full_name], [course], [year_level]) VALUES (@full_" +
                "name, @course, @year_level);\r\nSELECT student_id, full_name, course, year_level F" +
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@year_level", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "year_level", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Students] SET [full_name] = @full_name, [course] = @course, [year_level] = @year_level WHERE (([student_id] = @Original_student_id) AND ((@IsNull_full_name = 1 AND [full_name] IS NULL) OR ([full_name] = @Original_full_name)) AND ((@IsNull_course = 1 AND [course] IS NULL) OR ([course] = @Original_course)) AND ((@IsNull_year_level = 1 AND [year_level] IS NULL) OR ([year_level] = @Original_year_level)));
SELECT student_id, full_name, course, year_level FROM Students WHERE (student_id = @student_id)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@year_level", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "year_level", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_year_level", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "year_level", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::student_DEQUIT_IT13.Properties.Settings.Default.StudentDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT student_id, full_name, course, year_level FROM dbo.Students";
        ...
        public virtual int Delete(int Original_student_id, string Original_full_name, string Original_course, string Original_year_level) {
            ...
            if ((Original_year_level == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[6].Value = ((string)(Original_year_level));
            }
        ...
        public virtual int Insert(string full_name, string course, string year_level) {
            if ((full_name == null)) {
            ...
            if ((year_level == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[2].Value = ((string)(year_level));
            }
        ...
        public virtual int Update(string full_name, string course, string year_level, int Original_student_id, string Original_full_name, string Original_course, string Original_year_level, int student_id) {
            if ((full_name == null)) {
            ...
            if ((year_level == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(year_level));
            }
            ...
            if ((Original_year_level == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = ((string)(Original_year_level));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string full_name, string course, string year_level, int Original_student_id, string Original_full_name, string Original_course, string Original_year_level) {
            return this.Update(full_name, course, year_level, Original_student_id, Original_full_name, Original_course, Original_year_level, Original_student_id);
        }
    }
